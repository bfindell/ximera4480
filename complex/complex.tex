...
\begin{problem} % Need the rest of alpha
...
%\begin{problem}
%Show that if p and q are complex numbers and k > 0, then the graph of   is a circle or a line in the complex plane.  Specify the conditions under which the graph is a line.  
%\end{problem}
%
%\begin{problem}
%Pick a complex number   where a and b are integers and  .  Let  .  Find the length of z.  What do you notice?  Explain how you can use this idea to generate some ?useful collections of numbers.?  Show that the method works and explain why it is necessary that a and b be integers with  .  
%\end{problem}
