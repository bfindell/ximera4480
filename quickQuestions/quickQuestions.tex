...
\begin{question}
Suppose $f$ is a function with a domain and range that are both subsets of the real numbers and that $f(3)=2$.  Based on this information:  
\begin{parts}
\item Where is the $3$?  \begin{freeResponse}\end{freeResponse}
\item Where is the $2$? \begin{freeResponse}\end{freeResponse}
\item Where is the $f(3)$?  \begin{freeResponse}\end{freeResponse}
\end{parts}
\end{question}
