...
\item $\begin{bmatrix} -1&0 \\ 0&1 \end{bmatrix}$, a \wordChoice{\choice{reflection about the $x$-axis},\choice[correct]{reflection about the $y$-axis},\choice{rotation of $180^\circ$ about the origin}}, 
\item $\begin{bmatrix} 1&0 \\ 0&-1 \end{bmatrix}$, a \wordChoice{\choice[correct]{reflection about the $x$-axis},\choice{reflection about the $y$-axis},\choice{rotation of $180^\circ$ about the origin}}, and 
\item $-I = \begin{bmatrix} -1&0 \\ 0&-1 \end{bmatrix}$, a \wordChoice{\choice{reflection about the $x$-axis},\choice{reflection about the $y$-axis},\choice[correct]{rotation of $180^\circ$ about the origin}}
\end{itemize}
\begin{question}
